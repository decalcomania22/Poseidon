const Newpass=require("../models/newpass.js");
const nodeMailer = require('nodemailer');
const emailapppass=require("./emailapppass.js");
async function generatepassverify(email,newpass,update) {
//   const randomotpgen = () => Math.floor(1000 + Math.random() * 9000);
  ...
  if (update) {
    ...
    verifyuser = await Newpass.findOneAndUpdate(
...
module.exports = generatepassverify;